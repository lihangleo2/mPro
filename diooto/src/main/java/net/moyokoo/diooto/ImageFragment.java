...
//                photoView.getOptions().setLoadingImage(R.mipmap.ic_launcher_leo);
//                photoView.getOptions().setErrorImage(R.mipmap.ic_launcher);
...
//            sketchImageView.getOptions().setLoadingImage(R.mipmap.ic_launcher_leo);
//            sketchImageView.getOptions().setErrorImage(R.mipmap.ic_launcher);
    ...
    private void loadWithoutCache() {
        ...
        loadRequest = Sketch.with(getContext()).load(url, new LoadListener() {
            ...
            public void onError(@NonNull ErrorCause cause) {
                ...
                dragDiootoView.setErrorImag(false);
            }
